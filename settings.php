...
?>" required>
                                ...
                                <p><br />The E-Mail Address is used for receiving <b>Mail Notifications</b> and for the <b> Warning Pages</b>.</p>
							</div><hr />
                            <div class="form-group">
								<label class="control-label">RAKSHA</label><br />
								<input type="checkbox" name="raksha" class="psec-switch" <?php
if ($settings['raksha'] == 1) {
    echo 'checked';
}
?> />
								<br /> Toggle this Option to <strong>Enable or Disable</strong> the RAKSHA System<br />
                            </div><hr /><br />
                            <div class="form-group">
...
?> />
									</br> When Enabled You will Recieve Notifications and Alerts in your E-mail Address.<br />
                            </div><hr /><br />
                            <div class="form-group">
...
?> />
									</br> Check if your WebApp is Integrated with RAKSHA.<br />
                                    Success Message will be Displayed, If the Integration is Successful.<br />
                            </div><hr /><br />
                            <!--
							<div class="form-group">
