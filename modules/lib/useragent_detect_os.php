...
{
    private static $_windows_version = array("10.0" => array("10", "6"), "6.4" => array("10", "6"), // Windows 10 before 10240
        "6.3" => array("8.1", "5"), "6.2" => array("8", "5"), "6.1" => array("7", "4"), "6.0" => array("Vista", "3"), "5.2" => array("Server 2003", "2"), "5.1" => array("XP", "2"), "5.01" => array("2000 Service Pack 1", "1"), "5.0" => array("2000", "1"), "4.0" => array("NT 4.0", "1"), "3.51" => array("NT 3.11", "1"));
...
This code defines a class useragent_detect_os for detecting the operating system that is 
being used to access a website. The class has a single public method called analyze() 
that takes a single argument, the user agent string.
The analyze() method first checks if the operating system is Windows by using a 
regular expression match on the user agent string. If it is Windows, 
it calls the private method analyzeWindows() to get information about the specific version of Windows in use. 
If it is not Windows, the method checks if it is Linux, and if it is not, calls the private method analyzeOther().
It then sets some additional properties such as x64, title and dir, and returns an array containing the 
