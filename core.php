...
<head>
    ...
    <title>RAKSHA &rsaquo; Admin Panel</title>
        ...
        <ul class="nav navbar-nav">
		  ...
		  <form class="form-inline ml-3" action="ip-lookup.php" method="get">
      		  <div class="input-group input-group-sm">
      		    <input type="text" name="ip" class="form-control form-control-navbar" placeholder="IP Tracer" required>
...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="Visit Site" data-toggle="tooltip" data-placement="bottom">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link">
      <span class="brand-text font-weight-light"><i class="fas fa-shield"></i> <h4><b>RAKSHA</b></h4></span>
    </a></center>
	...
	<div class="sidebar">
	  ...
	  <ul class="nav nav-pills nav-sidebar nav-legacy flex-column" data-widget="treeview" role="menu">
		<li class="nav-header"><h5>NAVIGATION</h5></li>
...
?>">
        ...
        <li class="nav-header"><h5>PROTECTION</h5></li>
...
?>     
		...
		<li class="nav-item <?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'maliciousbots.php') {
        echo 'active';
    }
?>">
...
?>">
              <i class="fas fa-user-secret"></i>&nbsp; <p>Malicious Bots
<?php
...
?>">
              <i class="fas fa-globe"></i>&nbsp; <p>Proxy Services
<?php
...
?>">
              <i class="fas fa-keyboard"></i>&nbsp; <p>Spam Agents
<?php
...
?>     
        ...
        <li class="nav-item <?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'censor-words.php') {
        echo 'active';
    }
?>">
           <a href="censor-words.php" class="nav-link <?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'censor-words.php') {
        echo 'active';
    }
?>">
              <i class="fas fa-filter"></i>&nbsp; <p>Censor Words
<?php
...
?>">
              <i class="fas fa-ban"></i>&nbsp; <p>Access Bans <i class="fas fa-angle-right right"></i>
           </p></a>
...
?>">
		...
		<li class="nav-header"><h5>INTERNAL CHECK</h5></li>
...
?>"><i class="far fa-file-alt"></i>&nbsp; <p>File Whitelist</p></a></li>
		...
		<li class="nav-header"><h5>ANALYTICS &nbsp;
<?php
...
?>">
              <i class="fas fa-align-justify"></i>&nbsp; <p>System Logs <i class="fas fa-angle-right right"></i>
           </p></a>
           <ul class="nav nav-treeview">
               <li class="nav-item <?php
...
?>"><i class="fas fa-robot"></i>&nbsp; <p>Bot Logs <span class="badge right badge-danger"><?php
    echo $lcount3;
?></span></p></a></li>
               <li class="nav-item <?php
...
?>">
        ...
        <li class="nav-header"><h5>SERVER TOOLS</h5></li>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> <a href="https://xorjun.github.io/" target="_blank">RAKSHA</a> v<?php echo $psec_version; ?></strong>
