...
?>
						<div class="card-header">
							<h3 class="card-title">Malicious Bots - Protection Module</h3>
						</div>
						<div class="card-body">
<?php
if ($settings['badbot_protection'] == 1 OR $settings['badbot_protection2'] == 1 OR $settings['badbot_protection3'] == 1) {
							...
							<div class="card-body">
                        	    <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <center>
                                        <h4>Malicious Bots</h4><hr />
                                        Detects the <b>Malicious bots</b> and blocks their access to the website
                                        <br /><br />
...
?> />
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-body bg-light">
                                        <center>
                                        <h4>Hidden Bots</h4><hr />
                                        Detects the <b>hidden & anonymous bots</b> and blocks their access.<br />
                                        <br />
...
?> />
                ...
                <div class="col-md-4">
                     <div class="card card-primary card-outline">
                        	<div class="card-header">
								<h3 class="card-title"><i class="fas fa-info-circle"></i> What is Malicious Bot</h3>
							</div>
							<div class="card-body">
                                <strong>Malicious</strong>, <strong>Fake</strong> and <strong>Hidden Bots</strong> are bots that consume bandwidth, slow down your server, steal your content and look for vulnerability to compromise your server.
                        	</div>
                     </div>
                     <div class="card card-primary card-outline">
                        	<div class="card-header">
